...
export class AppComponent {
  ...
  students1: Array<Istudent1> = [
    { name: 'Amit', age: 20 },
    { name: 'Pooja', age: 22 },
  ];
  products2: Array<Iprod2> = [
    { id: 1, name: 'Laptop' },
    { id: 2, name: 'Mobile' },
  ];
  users: Array<Iusers> = [
    { id: 101, username: 'john' },
    { id: 102, username: 'jane' },
  ];
  tasks: Array<Itasks> = [
    { task: 'Angular Practice', completed: false },
    { task: 'Meeting', completed: true },
  ];
  books1: Array<Ibooks1> = [
    { title: 'Angular Basics', author: 'John' },
    { title: 'TS Guide', author: 'Smith' },
  ];
  posts: Array<Iposts> = [
    { id: 1, title: 'First Post' },
    { id: 2, title: 'Second Post' },
  ];
  employees1: Array<Iemployees1> = [
    { name: 'Ravi', dept: 'HR' },
    { name: 'Neha', dept: 'IT' },
  ];
  orders1: Array<Iorders1> = [
    { orderId: 1, item: 'Pen' },
    { orderId: 2, item: 'Notebook' },
  ];
  flights1: Array<Iflights1> = [
    { flightNo: 'AI101', destination: 'New York' },
    { flightNo: 'AI202', destination: 'London' },
  ];
  expenses = [
    { category: 'Food', amount: 250 },
    { category: 'Travel', amount: 500 },
  ];
  expenses1: Array<IExpences> = [
    { category: 'Food', amount: 250 },
    { category: 'Travel', amount: 500 },
  ];
  ...
  teams: Array<Iteams> = [
    {
      ...
      members: ['Alice', 'Charlie', 'Mike', 'Jake', 'Sarah', 'David'],
    },
    {
      teamId: 2,
      project: 'Mobile App Development',
      members: ['Mike', 'Laura', 'Charlie', 'Charlie', 'Alice', 'Jake'],
    },
    {
      teamId: 3,
      project: 'API Integration',
      members: ['Charlie', 'Mike', 'Alice', 'Sarah', 'Jake', 'Laura'],
    },
    {
      teamId: 4,
      project: 'Chatbot Implementation',
      members: ['Mike', 'Charlie', 'Jake', 'Laura', 'Sarah', 'Alice'],
    },
    {
      teamId: 5,
      project: 'Design Update',
      members: ['Mike', 'Charlie', 'Laura', 'Jake', 'Alice', 'Sarah'],
    },
    {
      teamId: 6,
      project: 'Data Cleanup',
      members: ['Charlie', 'Mike', 'Jake', 'Alice', 'Laura', 'Sarah'],
    },
  ];
  ...
  workoutPlans: Array<IworkoutPlans> = [
    {
      id: 1,
      day: 'Monday',
      activities: ['Push-up', 'Squat', 'Planks', 'Lunges', 'Dips', 'Crunches'],
    },
    {
      id: 2,
      day: 'Tuesday',
  ...
  events: Array<Ievents> = [
    {
      ...
      attendees: ['Mike', 'Charlie', 'Alice', 'Jake', 'Laura', 'Sarah'],
    },
    {
      id: 2,
      event: 'Music Fest',
      attendees: ['Mike', 'Charlie', 'Charlie', 'Mike', 'Alice', 'Jake'],
    },
    {
      id: 3,
      event: 'Art Gala',
      attendees: ['Mike', 'Charlie', 'Laura', 'Alice', 'Jake', 'Mike'],
    },
    {
      id: 4,
      event: 'Business Summit',
      attendees: ['Mike', 'Charlie', 'Mike', 'Alice', 'Charlie', 'Mike'],
    },
    {
      id: 5,
      event: 'Developer Meetup',
      attendees: ['Mike', 'Charlie', 'Mike', 'Jake', 'Charlie', 'Mike'],
    },
    {
      id: 6,
  ...
  restaurants: IRestaurant[] = [
    {
      id: 1,
      name: 'Pizza Town',
      menus: ['Pizza', 'Pasta', 'Sides', 'Beverage', 'Burger', 'Dessert'],
    },
    {
      id: 2,
      name: 'Burger Heights',
      menus: ['Burgers', 'Fries', 'Shakes', 'Sides', 'Beverage', 'Chicken'],
    },
    {
      id: 3,
      name: 'Healthy Eats',
      menus: ['Salads', 'Bowls', 'Protein', 'Sides', 'Beverage', 'Vegan'],
    },
    {
      id: 4,
      name: 'Sushi World',
      menus: ['Sushi', 'Ramen', 'Tempura', 'Beverage', 'Sides', 'Nigiri'],
    },
    {
      id: 5,
      name: 'BBQ Haven',
      menus: ['Ribs', 'Brisket', 'Sides', 'Beverage', 'Fries', 'Burger'],
    },
    {
      id: 6,
      name: 'Taco Rush',
      menus: ['Tacos', 'Burritos', 'Quesadilla', 'Sides', 'Beverage', 'Salsa'],
    },
  ];
  ...
  departments: Idepartments[] = [
    {
      id: 1,
      department: 'HR',
      manager: 'Alice Harper',
      employees: ['Mike', 'Charlie', 'Laura', 'Jake', 'Sarah', 'Alice'],
    },
    {
      id: 2,
      department: 'Engineering',
      manager: 'Charlie Brown',
      employees: ['Mike', 'Charlie', 'Jake', 'Alice', 'Charlie', 'Mike'],
    },
    {
      id: 3,
      department: 'Design',
      manager: 'Mike Rogers',
      employees: ['Charlie', 'Mike', 'Jake', 'Alice', 'Charlie', 'Mike'],
    },
    {
      id: 4,
      department: 'Support',
      manager: 'Jake Peterson',
      employees: ['Mike', 'Charlie', 'Mike', 'Alice', 'Charlie', 'Mike'],
    },
    {
      id: 5,
      department: 'Management',
      manager: 'Laura James',
      employees: ['Mike', 'Charlie', 'Mike', 'Jake', 'Charlie', 'Mike'],
    },
    {
      id: 6,
      department: 'QA',
  ...
  courses: Icourses[] = [
    ...
    },
    {
      ...
      instructor: 'Alice Harper',
      hours: 35,
    },
    {
      id: 4,
      title: 'NodeJS API Development',
      instructor: 'Jake Peterson',
      hours: 50,
    },
    {
      id: 5,
